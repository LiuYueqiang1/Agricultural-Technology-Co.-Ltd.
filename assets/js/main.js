...
const I18N = {
  ...
  "prod3.t": { zh: "防水PE布棉被", en: "Waterproof PE fabric-Surface Quilt" },
  "prod3.d": { zh: "PE布面料，防水耐磨，适合多雨多雪地区。", en: "PE-fabric surface, waterproof and wear-resistant for wet climates." },
  "prod3.tag": { zh: "防水款", en: "Waterproof" },
  "prod3.s1": { zh: "PE布面", en: "PE fabric" },
